(function(window) { (function(t) {
		t.DOMException = void 0,
		t.Headers = d,
		t.Request = _,
		t.Response = M,
		t.fetch = j;
		var r = "undefined" != typeof globalThis && globalThis || "undefined" != typeof self && self || void 0 !== t && t || {},
		n = "URLSearchParams" in r,
		i = "Symbol" in r && "iterator" in Symbol,
		o = "FileReader" in r && "Blob" in r &&
		function() {
			try {
				return new Blob,
				!0
		...
		function _(t, e) {
			...
			if (this.credentials = e.credentials || this.credentials || "same-origin", !e.headers && this.headers || (this.headers = new d(e.headers)), this.method = (n = e.method || this.method || "GET", i = n.toUpperCase(), b.indexOf(i) > -1 ? i: n), this.mode = e.mode || this.mode || null, this.signal = e.signal || this.signal ||
			function() {
				if ("AbortController" in r) return (new AbortController).signal
			} (), this.referrer = null, ("GET" !== this.method || "HEAD" !== this.method || "no-store" !== e.cache && "no-cache" !== e.cache)) {
				var s = /([?&])_=[^&]*/;
		...
		function j(t, e) {
			return new Promise((function(n, i) {
				...
				} (s.url), !0), "include" === s.credentials ? u.withCredentials = !0 : "omit" === s.credentials && (u.withCredentials = !1), "responseType" in u && (o ? u.responseType = "blob": a && (u.responseType = "arraybuffer")), e && "object" == typeof e.headers && !(e.headers instanceof d || r.Headers && e.headers instanceof r.Headers)) {
					var h = [];
					Object.getOwnPropertyNames(e.headers).forEach((function(t) {
						h.push(l(t)),
						u.setRequestHeader(t, f(e.headers[t]))
					})),
					s.headers.forEach((function(t, e) { - 1 === h.indexOf(e) && u.setRequestHeader(e, t)
					}))
		...
		j.polyfill = !0,
		r.fetch || (r.fetch = j, r.Headers = d, r.Request = _, r.Response = M)
	})(window);
})(window);