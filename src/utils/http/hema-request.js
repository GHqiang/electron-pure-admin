...
const { hemaToken } = storeToRefs(userInfoAndTokens);
const { removeHemaUserInfo } = userInfoAndTokens;
...
var a = function (e) {
  ...
  // e.city_id = '500'
  // e.cinema_id = '19'
  e.session_id = hemaToken.value || "";
  // console.log("jinjiRequest===>", e);
};
  ...
  response => {
    ...
    if (
      ...
      if (data.errcode === "205" && data.msg === "登录失效") {
        ...
        ElMessageBox.confirm("河马国际登录失效，请重新登录", "提示", {
