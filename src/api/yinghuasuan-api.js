...
const queryStayOfferList = params =>
  axios.post("/open/v1/invitation/index", params, { timeout: 20 * 1000 });

// 提交报价
const submitOffer = params =>
  axios.post("/open/v1/invitation/quote", params);
...
const confirmOrder = params =>
  axios.post("/open/v1/order/confirm", params);
...
const submitTicketCode = params =>
  axios.post("/open/v1/order/ticket", params);
