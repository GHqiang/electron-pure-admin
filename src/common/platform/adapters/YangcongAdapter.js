// 洋葱平台适配器
// 实现洋葱平台特定的API调用和参数转换逻辑

import BasePlatformAdapter from "../../core/BasePlatformAdapter.js";
import yangcongApi from "@/api/yangcong-api.js";

/**
 * 洋葱平台适配器
 */
export default class YangcongAdapter extends BasePlatformAdapter {
  /**
   * 构造函数
  ...
  constructor(logger, isTestOrder = false) {
    super("yangcong", yangcongApi, logger, isTestOrder);
  }
