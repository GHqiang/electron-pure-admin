<template>
  <div class="auto-offer">
    <el-button type="primary" @click="startAutoOffer" v-throttle
      >一键启动</el-button
    >
    <el-button type="primary" @click="stopAutoOffer" v-throttle>停止</el-button>
    <PlatOfferRule></PlatOfferRule>
    <el-divider content-position="center">报价记录</el-divider>
    <HistoryOfferRecord></HistoryOfferRecord>
  </div>
</template>
...
import PlatOfferRule from "@/components/PlatOfferRule.vue";
